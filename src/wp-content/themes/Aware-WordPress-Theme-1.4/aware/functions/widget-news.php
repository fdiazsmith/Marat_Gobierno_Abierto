...
<div class="news-widget-item">
        <h3 class="posttitle"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3><!--Post Title-->
        <h5><a href="<?php the_permalink(); ?>"><?php the_time(get_option('date_format')); ?></a> <?php _e('by', 'framework'); ?> <a href="<?php the_permalink(); ?>"><?php the_author(); ?></a></h5><!--Misc Info-->
        <?php 
